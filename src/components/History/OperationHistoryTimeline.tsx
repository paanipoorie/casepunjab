...
import { History, Eye, Trash2, Plus, CornerDownRight, Search, Compass, RefreshCw } from 'lucide-react';
...
export const OperationHistoryTimeline: React.FC = () => {
  ...
  return (
    <div id="history" className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm">
